...
from threeD_backscatter_over_london_PCA import read_orography

def load_plot_surface_type(datadir, UK_lat_constraint, UK_lon_constraint, savedir, model_type):
    """
    PLot UKV land cover surface type - needs some reworking
    :param datadir:
    :param UK_lat_constraint:
    :param UK_lon_constraint:
    :param savedir:
    :param model_type:
    :param SurfTypeD:
    :return:
...
if __name__ == '__main__':
    ...
    if data_to_plot == 'surface type':
        ...
        load_plot_surface_type(datadir, UK_lat_constraint, UK_lon_constraint, savedir, model_type, SurfTypeD)
        ...
        # extract murk data - UKV already subsampled in time and height, LM isn't
        if model_type == 'UKV':
            murk_aer_data = murk_aer.data
        elif model_type == 'LM':
            height_idx = 4
            month_idx = 7
